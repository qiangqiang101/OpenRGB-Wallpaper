...
Public Class Main
    ...
    Private Sub Main_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        lblPWCUR.Value2 = $"{nudCPUUsageValue.Value}%"
    ...
    Private Sub tsmiConnect_Click(sender As Object, e As EventArgs) Handles tsmiConnect.Click
        For Each form In wpForms.Where(Function(x) Not x.Device.AutoConnect)
            form.Connect()
        Next
    End Sub
    ...
    Private Sub btnAddScreen_Click(sender As Object, e As EventArgs) Handles btnAddScreen.Click
        ...
        With newTab
            ...
            Dim dev As New Device
            With dev
                .Device = New E131Device() With {.AutoConnect = False, .Name = $"Wallpaper{UserSettings.E131Devices.Count + 1}", .Port = 6742,
                    .Position = Screen.PrimaryScreen.Bounds.Location, .Size = Screen.PrimaryScreen.Bounds.Size}
                .Dock = DockStyle.Fill
            End With
            newTab.Controls.Add(dev)
            .Tag = dev
    ...
    Private Sub tsmiPause_Click(sender As Object, e As EventArgs) Handles tsmiPause.Click
        ...
        If wpForms.FirstOrDefault.IsPaused Then tsmiPause.Text = "Play" Else tsmiPause.Text = "Pause"
    End Sub
